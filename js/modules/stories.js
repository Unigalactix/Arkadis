    ...
    render: () => `
        <div id="stories-section" class="tab-content hidden space-y-12 animate-fade-in">
            <div class="text-center space-y-4 mb-8">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto text-lg">Detailed accounts of heroism, betrayal, and the struggle for freedom within the Mysterious Continent.</p>
            </div>

            <div class="scene-bushes mb-8"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-orange-600 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, var(--hue-vedic-saffron), var(--hue-hellenic-gold));">01</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-slate-900">The First Selection</h3>
                    </div>
                    <div class="text-gray-700 leading-relaxed flex-1 space-y-4">
                        <p>Nearly fifteen centuries after Arkadis the Founder first raised the sanctuary from the sea, his successors did not look for kings or generals to populate the second dome. They sought those who understood the "Sub-Space Vibration"&mdash;the pulse of the earth. In 542 AD, as Alexandria fell into chaos, twelve individuals&mdash;Greek philosophers, Vedic astronomers, and Byzantine mystics alike&mdash;were spirited away via a vessel that moved without sails.</p>
                        <p>Among them was Aethelred, a blind mapmaker who could sense tectonic shifts through his feet. He was the first to realize that Arkadis was not naturally formed. "We are standing on a giant clock," he famously whispered. This story documents the grueling first decade, where the 'Twelve' wove Byzantine gold-work and liturgy into the Founder's Hellenic-Vedic order, developing the basic laws of Gilded Secrecy to protect their new paradise from the encroaching darkness of the Middle Ages.</p>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-rose-400 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col bg-white">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, var(--hue-vedic-vermilion), #fb7185);">02</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-slate-900">The Knight's Anchor</h3>
                    </div>
                    <div class="text-gray-700 leading-relaxed flex-1 space-y-4">
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-violet-600 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col bg-violet-50/10">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, #7e22ce, #8b5cf6);">03</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-slate-900">Shadow Hearts</h3>
                    </div>
                    <div class="text-gray-700 leading-relaxed flex-1 space-y-4">
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-sky-400 shadow-lg hover:shadow-2xl transition-all h-full bg-slate-900 text-white flex flex-col">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, #0ea5e9, #38bdf8);">04</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-sky-400">The Spark of Unveiling</h3>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-green-600 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col bg-green-50/5">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, #65a30d, #84cc16);">06</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-slate-900">The Silent Gardener</h3>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-slate-800 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, #1e293b, #475569);">07</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-slate-900">Void Echoes</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <div class="glass-panel p-10 rounded-3xl border-t-8 border-red-700 shadow-lg hover:shadow-2xl transition-all h-full flex flex-col bg-red-50/10">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="tale-number" style="background: linear-gradient(135deg, #b91c1c, #dc2626);">08</div>
                        <h3 class="text-2xl md:text-3xl font-bold text-red-700">The Omega Protocol</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <div class="glass-panel p-10 rounded-2xl border-l-4 border-slate-400">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="tale-number" style="width:2rem;height:2rem;font-size:0.8rem;background: linear-gradient(135deg, #64748b, #94a3b8);">09</div>
                        <h3 class="text-xl font-bold">The Printer's Errand</h3>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-2xl border-l-4 border-rose-900">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="tale-number" style="width:2rem;height:2rem;font-size:0.8rem;background: linear-gradient(135deg, #881337, #be123c);">10</div>
                        <h3 class="text-xl font-bold">Vespera's Whisper</h3>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-2xl border-l-4 border-sky-600">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="tale-number" style="width:2rem;height:2rem;font-size:0.8rem;background: linear-gradient(135deg, #0284c7, #38bdf8);">11</div>
                        <h3 class="text-xl font-bold">The Code of Mira</h3>
                    </div>
                ...
                <div class="glass-panel p-10 rounded-2xl border-l-4 border-yellow-500 bg-yellow-50/20">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="tale-number" style="width:2rem;height:2rem;font-size:0.8rem;background: linear-gradient(135deg, #ca8a04, #fbbf24); color:#241a10;">12</div>
                        <h3 class="text-xl font-bold text-orange-950">The Prince's Doubt</h3>
                    </div>
